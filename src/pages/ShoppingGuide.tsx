...
import {GuideSection, WidgetGuide} from "../components/shopping-guide/guide-components";
import {Col, Row} from "react-bootstrap";
import LocalPhoneIcon from "@mui/icons-material/LocalPhone";
import {express, shield, success, threeHand} from "../assets/images/product-detail/imges"

function ShoppingGuide() {
    return (
        <Row className={"p-2 ps-lg-5 m-0"}>
            <Col lg={8} md={12} className={"col-left"}>
                <GuideSection>
                    <div className="std">
                        <h1>
                        ...
                        <p>
                            ...
                            hết. Với website XE ĐẠP KIMI, bạn có thể dễ dàng chọn lựa và mua sắm các loại xe đạp từ
                            các
                        ...
                        <p>
                            Phương thức đầu tiên và cũng là phương thức truyền thống nhất khi mua hàng chính là gọi
                            điện
                            trực tiếp. Đây là cách nhanh chóng và thuận tiện, đặc biệt đối với những người không
                            quen sử
                            dụng các thiết bị công
                            nghệ hoặc muốn được tư vấn trực tiếp từ nhân viên bán hàng. Để thực hiện mua hàng qua
                            điện
                            thoại, bạn cần làm theo các bước sau:
                        </p>
                        <ul>
                            <li>Bạn tham khảo các mẫu xe đạp trên Website hiện có.</li>
                            <li>Ghi chú lại mã sản phẩm và các thông tin cần thiết để tiện lợi hơn khi gọi điện.
                            </li>
                            <li>
                                Gọi số <strong>0855354919</strong> từ 08:00 đến 21:00 các ngày trong tuần để đặt
                                hàng.
                                Nhân viên chúng tôi luôn sẵn sàng phục vụ, tư vấn và hỗ trợ quý khách mua được sản
                                phẩm
                                phù hợp, ưng ý.
                            </li>
                        </ul>
                        <figure>
                            <img src={"src/assets/images/shopping-guide/huong-dan-mua-hang-1.jpg"} width="683"
                                 height="454" alt={"huong-dan-mua-hang-1.jpg"}/>
                        ...
                        <p>
                            Nếu bạn thích sự tiện lợi và nhanh chóng của việc mua sắm trực tuyến, XE ĐẠP KIMI cũng
                            cung
                            cấp dịch vụ đặt mua hàng online ngay trên website. Dưới đây là hướng dẫn chi tiết từng
                            bước
                        ...
                        <p>
                            ...
                            . Giao diện trang chủ sẽ hiển thị nhiều sản phẩm nổi bật, danh mục sản phẩm và các
                            chương
                            trình khuyến mãi hiện có. Nếu bạn đã có sản phẩm cụ thể muốn mua, hãy sử dụng thanh tìm
                            kiếm
                            ở đầu trang để nhập tên hoặc
                            mã sản phẩm. Ví dụ, bạn muốn tìm xe đạp địa hình, chỉ cần nhập “xe đạp địa hình” vào
                            thanh
                        ...
                        <p>
                            Khi bạn đã tìm được sản phẩm ưng ý, hãy nhấp vào nút xem chi tiết bên dưới để xem chi
                            tiết.
                            Trang chi tiết sản phẩm sẽ cung cấp đầy đủ thông tin về giá, mô tả sản phẩm, các tính
                            năng,
                        ...
                        <figure>
                            <img
                                ...
                                width="683"
                                height="454" alt={"huong-dan-mua-hang-4.jpg"}/>
                            <img
                                src={"src/assets/images/shopping-guide/huong-dan-mua-hang-9.jpg"}
                                width="683"
                                height="454" alt={"huong-dan-mua-hang-9.jpg"}/>
                            <img
                                src={"src/assets/images/shopping-guide/huong-dan-mua-hang-10.jpg"}
                                width="683"
                                height="454" alt={"huong-dan-mua-hang-10.jpg"}/>
                            <figcaption>Trang sản phẩm đầy đủ thông tin, chi tiết</figcaption>
                        </figure>
                        <p>
                            Nếu bạn quyết định mua sản phẩm, hãy chọn màu và số lượng và sau đó bấm vào nút “Thêm
                            vào
                            giỏ hàng”. Một cửa sổ sẽ xuất hiện thông báo sản phẩm đã được thêm vào giỏ hàng của bạn.
                            Bạn
                        ...
                        <figure>
                            <img
                                ...
                                width="683"
                                height="454" alt={"huong-dan-mua-hang-11.jpg"}/>
                        ...
                        <figure>
                            <img
                                ...
                                width="683"
                                height="454" alt={"huong-dan-mua-hang-2.jpg"}/>
                        ...
                        <p>
                            ...
                            web. Trang giỏ hàng sẽ hiển thị toàn bộ sản phẩm bạn đã chọn, số lượng, giá thành và
                            tổng
                        ...
                        <figure>
                            <img
                                ...
                                width="683"
                                height="454"
                                alt={"huong-dan-mua-hang-5.jpg"}/>
                            <figcaption>Trang giỏ hàng cho phép bạn điều chỉnh số lượng sản phẩm hoặc xóa bỏ các mặt
                                hàng không mong muốn
                            </figcaption>
                        </figure>
                        <p>
                            Khi đã kiểm tra kỹ giỏ hàng, hãy bấm vào nút “Tiến hành đặt hàng”. Trang thanh toán sẽ
                            yêu
                            cầu bạn cung cấp thông tin cá nhân, địa chỉ giao hàng và phương thức thanh toán thuận
                            tiện
                        ...
                        <figure>
                            <img src={"src/assets/images/shopping-guide/huong-dan-mua-hang-6.jpg"} width="683"
                                 height="454" alt={"huong-dan-mua-hang-6.jpg"}/>
                            ...
                            <img src={"src/assets/images/shopping-guide/huong-dan-mua-hang-7.jpg"} width="683"
                                 height="454" alt={"huong-dan-mua-hang-7.jpg"}/>
                            <figcaption> Ngoài ra shop còn cho phép thanh toán bằng mã QR
                            </figcaption>
                        </figure>
                        <p>
                            Mua hàng tại XE ĐẠP KIMI rất đơn giản và tiện lợi với hai phương thức chính là gọi điện
                            trực
            ...
            <Col lg={4} md={12} className={"col-right"}>
                <WidgetGuide>
                    <Row>
